...
def train_kitti():
    ...
    cfg.model_path = './model_trained/resnet50_weights_tf_dim_ordering_tf_kernels.h5'
    cfg.simple_label_file = '../../dataset/youcook2/YouCook2/yc_bbox.txt'

    if not (os.path.exists('all_images.pkl') and os.path.exists('classes_count.pkl') and os.path.exists('class_mapping.pkl')):
        all_images, classes_count, classes_count = get_data(cfg.simple_label_file)
        with open('all_images.pkl', 'wb') as f:
            pickle.dump(all_images, f)
        with open('classes_count.pkl', 'wb') as f:
            pickle.dump(classes_count, f)
        ...
        with open('classes_count.pkl', 'rb') as f:
        ...
        while True:
            try:
                ...
                if iter_num == epoch_length:
                    ...
                    df.to_csv("result.csv", index=False, encoding="utf-8", mode='a', header=False)
